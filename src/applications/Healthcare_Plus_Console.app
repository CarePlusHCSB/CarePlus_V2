...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>This is the console application which provides an unified to the Agents (internal users) working on the Payer&apos;s side</description>
    ...
    <label>Healthcare Plus Console</label>
    <listPlacement>
    ...
    <logo>Health_Plus/Health_Plus_logo.jpg</logo>
