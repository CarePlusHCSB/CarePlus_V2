...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>The healthcare utilization management is the process of evaluation of the medical necessity and appropriateness of the healthcare services. This application will enable us to capture and manage the utilization management services.</description>
    <detailPageRefreshMethod>none</detailPageRefreshMethod>
    <domainWhitelist>
        <domain>*.QNXT48.aspx</domain>
    ...
    <logo>Health_Plus/Care_Logo.jpg</logo>
